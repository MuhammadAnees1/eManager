...
import com.example.emanager.adaptors.AccountsAdapter;
import com.example.emanager.adaptors.CategoryAdapter;
import com.example.emanager.databinding.FragmentAddTransactionBinding;
import com.example.emanager.databinding.ListDilogBinding;
...
public class AddTransactionFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.category.setOnClickListener(c-> {
            ListDilogBinding dialogBinding = ListDilogBinding.inflate(inflater);
